        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{route('Cate.create')}}">Thêm Danh Mục</a></li>
                    <li><a href="{{route('Cate.index')}}">Danh Sách Danh Mục</a></li>
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{route('Task.create')}}">Thêm </a></li>
                    <li><a href="{{route('Task.index')}}">Danh Sách Bài Viết</a></li>
                </ul>
